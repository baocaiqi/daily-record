...
| # | 单词/短语 | 释义 | 备注 |
|---|-----------|------|------|
| 1 | **activist** | n. 积极分子，活动家，激进分子 | `[词根]` act- = do/drive（做，驱动）→ act → active → activist；`[短语]` political activist 政治活动家 / human rights activist 人权活动人士 / environmental activist 环保活动人士 / student activist 学生运动积极分子；`[辨]` activist（活动家，偏社会/政治运动）≠ activist ≠ activist ≠ extremist（极端分子，贬义）；`[考研]` 社会运动/政治类阅读高频词 |
| 2 | **unrest** | n. 动荡，骚乱，不安 | `[词根]` un-（不）+ rest（安宁）→ 不安宁 → 动荡；`[短语]` social unrest 社会动荡 / political unrest 政治骚乱 / civil unrest 内乱 / labour unrest 劳工骚动 / growing unrest 日益加剧的不安；`[辨]` unrest（社会/政治动荡，集体）≠ restlessness（个人的焦躁不安）；`[考研]` 国际政治/社会类阅读关键词 |
...
| 12 | **gracious** | adj. 慈祥的，和蔼的；优雅的；仁慈的 | `[词根]` grac-/grat- = pleasing/thankful（令人愉悦的，感恩）→ grace → gracious；`[短语]` a gracious smile 慈祥的微笑 / gracious host 亲切好客的主人 / gracious living 优雅的生活 / gracious God! 天哪！（感叹词）；`[辨]` gracious（亲切仁慈的，褒义，上位者对下位者）≠ graceful（优美的，偏动作/形态）≠ grateful（感激的，被动感受）≠ gracious ≠ graceful；⚠️ 这对形近词是考研常见混淆词！`[惯用]` "She was gracious enough to forgive me." 她宽宏大量地原谅了我。 |
| 13 | **inarticulate** | adj. 不善言辞的；口齿不清的；难以言表的 | `[词根]` in-（不）+ articulate（清晰表达的）→ 不能清晰表达的；`[短语]` inarticulate speaker 不善言辞的发言者 / inarticulate with rage 气得说不出话 / inarticulate speech 口齿不清的讲话；`[辨]` inarticulate（不善言辞，表达能力差）≠ incoherent（语无伦次，逻辑混乱）≠ mute（哑的，生理上不能说话）≠ taciturn（沉默寡言的，性格内向）；`[考研]` articulate / inarticulate 反义词对 |
| 14 | **unbiased** | adj. 公平的，无偏见的，不偏袒的 | `[词根]` un-（不）+ bias（偏见）+ -ed → 无偏见的；`[短语]` unbiased opinion 公正的意见 / an unbiased judge 不偏不倚的法官 / unbiased reporting 客观报道 / unbiased sample 无偏样本（统计术语）；`[辨]` unbiased（无偏见的，客观中立）≠ fair（公平的，通用）≠ impartial（不偏不倚的，公正的，正式/法律用语）≈ disinterested（无私心的，强调无利益关系）；`[考研]` 描述评价/判断立场的常用词 |
...
| 词对 | 区别 |
|------|------|
| **gracious** vs **graceful** | gracious = 仁慈亲切的（态度/性格，上位者对下位者）；graceful = 优美的（动作/形态）；⚠️ 考研常见混淆词 |
...
| 考点 | 说明 |
|------|------|
| **grave / grieve / grief 三词辨析** | grave = 坟墓 n. / 严重的 adj.；grieve = 悲伤 v.；grief = 悲痛 n.；词根 grav- = 重，考研阅读中根据上下文判断 |
...
| **enclosure 圈地运动** | 考研英语常涉及英国历史背景知识：the Enclosure Movement = 圈地运动（15-19世纪英国土地私有化过程） |
...
| **knee-jerk reaction 比喻义** | 考研阅读中 knee-jerk 常比喻"不假思索的本能反应"，非字面的"膝跳反射" |
